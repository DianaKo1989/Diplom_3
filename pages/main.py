...
class MainPage(BasePage):
    ...
    def open_main_page(self):
        ...
        self.wait_element_visibility_of_element_located(MainLocators.BUILDER_BUTTON)

    @allure.step('Открыть страницу авторизации')
    def open_login_page(self):
        self.open_url(MAIN_PAGE)
        self.click_element(MainLocators.PERSONAL_ACCOUNT_BUTTON)
        self.wait_element_visibility_of_element_located(MainLocators.HEADER_LOGIN_PAGE)
    ...
    def open_ingredient_pop_up(self):
        ...
        self.wait_element_visibility_of_element_located(MainLocators.HEADER_POP_UP)
    ...
    def close_ingredient_pop_up(self):
        ...
        self.wait_element_visibility_of_element_located(MainLocators.BUN_ITEM)
        return self.find_element(MainLocators.CLOSE_POP_UP)

    @allure.step('Добавить ингредиент в заказ')
    def add_items_in_order(self):
        self.wait_element_visibility_of_element_located(MainLocators.COUNTER_BUN)
    ...
    def click_button_create_order(self):
        self.wait_element_visibility_of_element_located(MainLocators.CREATE_ORDER_BUTTON)
        self.click_element(MainLocators.CREATE_ORDER_BUTTON)
        self.wait_element_visibility_of_element_located(MainLocators.CREATE_ORDER_POP_UP)
